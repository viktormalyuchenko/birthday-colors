  ...
  return (
    <>
      ...
      {isMounted &&
        ...
        createPortal(
          <div
            className="fixed inset-0 z-[99999] flex items-end sm:items-center justify-center bg-black/60 backdrop-blur-sm sm:p-4 transition-all"
            onClick={() => setIsOpen(false)}
          >
            <div
              className="bg-[#212121] text-white w-full sm:max-w-lg rounded-t-3xl sm:rounded-3xl p-6 shadow-2xl animate-in slide-in-from-bottom-10 sm:zoom-in-95"
            ...
            >
              ...
              <div className="flex gap-6 mb-8 overflow-x-auto hide-scrollbar pb-2 pt-2">
                <div className="flex flex-col items-center gap-3 shrink-0">
                  {generatedImage && !navigator.share ? (
                    <a
                      ...
                      className="w-16 h-16 rounded-full bg-emerald-500 flex items-center justify-center hover:scale-105 transition-transform shadow-lg"
                    >
                      <svg
                        width="28"
                        height="28"
                    ...
                    <button
                      ...
                      className="w-16 h-16 rounded-full bg-gradient-to-tr from-yellow-400 via-pink-500 to-purple-600 flex items-center justify-center hover:scale-105 transition-transform disabled:opacity-50 shadow-lg cursor-pointer"
                    >
                      {isGenerating ? (
                        "⏳"
                      ) : (
                ...
                >
                  <div className="w-16 h-16 rounded-full bg-[#0088cc] flex items-center justify-center group-hover:scale-105 transition-transform shadow-lg">
                    <svg
                      width="30"
                      height="30"
                      viewBox="0 0 24 24"
                ...
                <a
                  ...
                  className="flex flex-col items-center gap-3 shrink-0 group"
                >
                  <div className="w-16 h-16 rounded-full bg-[#0077FF] flex items-center justify-center group-hover:scale-105 transition-transform shadow-lg">
                    <svg
                      width="28"
                      height="28"
                      viewBox="0 0 24 24"
              ...
              <div className="flex items-center bg-[#0f0f0f] rounded-xl border border-gray-700 overflow-hidden p-1">
                ...
                <button
                  ...
                  className="bg-blue-600 hover:bg-blue-500 text-white font-medium text-sm px-6 py-3 rounded-lg transition-colors flex-shrink-0 cursor-pointer"
                >
