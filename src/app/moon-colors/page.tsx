...
export const metadata: Metadata = {
  title: "Лунные цвета зодиака | Астрология эмоций",
  description:
    "В каком знаке была Луна в день вашего рождения? Выберите свой лунный знак зодиака и узнайте истинный цвет своего подсознания и эмоций.",
  keywords: [
    "лунный цвет",
    "цвет лунного знака",
    "астрология цвета",
